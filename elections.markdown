...
To find out, we dive into nearly two decades of election data, tracking how the city’s districts have voted from 2005 to 2022. Our journey starts with a high-level overview of the political divide between left-wing and right-wing blocs — then narrows down to examine the rise and fall of individual parties and how district-level dynamics have shaped the broader political map.
